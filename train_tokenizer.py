...
def main():
    collect_wiki_corpus('korean', 'ko', 1000000)
...
def collect_wiki_corpus(language, lang, num_items):
    ...
    for title in wikipedia.random(num_items):
        p_text = wikipedia.page(title).content
        ...
        p_tokenized = ' '.join(nltk.word_tokenize(p_text))
...
def test_tokenization():
    ...
    tokenizer = nltk.data.load('/Users/woojin/nltk_data/tokenizers/punkt/korean.pickle')
